...
.IgnoreToken(L"SPACE",LR"(\s+)")
					...
					)+ztl::general_parser::GrammarSymbol(L"ELEMENT_CLOSE") | ztl::general_parser::GrammarSymbol(L"ELEMENT_CLOSE")+*(
					...
					.Create(ztl::general_parser::Normal(L"Element"))
						...
						( 
						( 
						( !(ztl::general_parser::GrammarSymbol(L"XText")) | !(ztl::general_parser::GrammarSymbol(L"XCData")) )
					 | !(ztl::general_parser::GrammarSymbol(L"XComment")) )
					 | !(ztl::general_parser::GrammarSymbol(L"XElement")) )
